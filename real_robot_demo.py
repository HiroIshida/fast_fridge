...
class FridgeDemo(object):
    ...
    def send_final_phase(self):
        ...
        demo.ri.angle_vector(demo.task_reach.robot_model.angle_vector(), time=2.0)
        time.sleep(1.2)
        demo.ri.angle_vector(demo.robot_model2.angle_vector(), time=2.0, time_scale=1.0)
